...
chesOffsets_Val <- c(0.0011,0.0021,0.0031,-0.0017,-0.0017,-0.0024,-0.0001,0.0006,-0.0002)

hist(chesOffsets_Val,breaks=7,main="New - Legacy Offset Values: n Sensors",
     xlab="Offset Difference (New-Legacy)")
